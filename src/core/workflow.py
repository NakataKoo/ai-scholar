...
def evaluator_optimizer_loop(
    pdf_images: list, initial_article: str, analysis: str, max_iterations: int | None = None
) -> str:
    ...
    while iteration < max_iterations:
        ...
        evaluation = evaluate_article(pdf_images, current_article, analysis)
        ...
        current_article = revise_article(pdf_images, current_article, feedback, analysis)
...
def process_section_with_workflow(pdf_images: list, section: str, context: str = "") -> tuple:
    ...
    final_article = evaluator_optimizer_loop(pdf_images, initial_article, analysis)
