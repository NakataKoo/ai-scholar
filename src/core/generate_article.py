...
def update_processing_results(
    sheet, row_index: int, detailed_summary: str, three_point_summary: str, processing_date: str
):
...
def load_prompt(filename: str) -> str:
    ...
    """
    # Navigate from src/core/ to project root, then to prompts/
...
def process_single_paper(sheet, row_index: int, url: str, title: str):
    ...
    try:
        ...
        update_processing_results(sheet, row_index, detailed_summary, three_point_summary, PROCESSING_DATE)
